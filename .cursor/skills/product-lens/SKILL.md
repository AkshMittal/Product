...
```
1. Read README, product-roadmap.md, recent commits, docs/
...
```
1. Walk the product as a new user
2. Document every friction point (confusing steps, errors, missing info)
3. Time each step
...
- `architecture-decision-records` when feature decisions have architectural implications
- `market-research` for competitive context
